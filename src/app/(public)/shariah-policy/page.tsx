...
const SECTIONS = [
  ...
  { number: "০৪", title: "রেফারেল ট্র্যাকিং ও কমিশন বিতরণ", body: "তিনটি মূল নিয়ম অনুযায়ী কমিশন বিতরণ করা হয়: (১) সরাসরি ক্রয়: কোন রেফারেল লিংক ছাড়া ক্রয় করলে সম্পূর্ণ কমিশন ইনশিরাহ প্ল্যাটফর্ম পায়। (২) ৩০ দিনের কুকি ট্র্যাকিং: প্রমোটার লিংকে ক্লিক করলে ৩০ দিন পর্যন্ত কুকি সক্রিয় থাকে — এই সময়ে সরাসরি সাইটে এসেও কিনলে প্রমোটার কমিশন পাবে (লাস্ট ক্লিক উইন্স)। (৩) সেলফ-পারচেস ব্লক: প্রমোটার নিজের লিংকে নিজে কিনলে কোন কমিশন পাবে না — সম্পূর্ণ কমিশন ইনশিরাহ পাবে।" },
  { number: "০৫", title: "পারিশ্রমিক ও ঘারার পরিহার", body: "কমিশন কেবলমাত্র সফল ও যাচাইকৃত ডেলিভারির ভিত্তিতে প্রদান করা হবে। প্রমোটার প্রতিটি বিক্রয়ে কমিশনের ৮০% পাবেন এবং বাকি ২০% প্ল্যাটফর্ম পরিচালনা ব্যয় হিসেবে রাখা হবে — এই হার সম্পূর্ণ স্বচ্ছ ও পূর্বনির্ধারিত।" },
  { number: "০৬", title: "স্বচ্ছতা ও সততার দায়িত্ব", body: "প্রমোটারকে তাদের অ্যাফিলিয়েট সম্পর্ক প্রকাশ্যে জানাতে হবে। ভুয়া তথ্য, বিভ্রান্তিমূলক বিজ্ঞাপন, কৃত্রিম ক্লিক বা নকল রূপান্তর সম্পূর্ণ নিষিদ্ধ এবং অ্যাকাউন্ট বাতিলের কারণ হতে পারে।" },
  { number: "০৭", title: "প্ল্যাটফর্মের ভূমিকা ও সীমাবদ্ধতা", body: "ইনশিরাহ একটি মধ্যস্থতাকারী প্ল্যাটফর্ম। মার্চেন্টের পণ্য বা সেবার শরীয়াহ-সম্মতির চূড়ান্ত যাচাই মার্চেন্টের নিজস্ব দায়িত্ব। তবে প্ল্যাটফর্ম প্রাথমিক যাচাই ও নীতিমালা প্রয়োগ করে।" },
  { number: "০৮", title: "চুক্তি বাতিল ও বকেয়া পরিশোধ", body: "যেকোনো পক্ষ প্ল্যাটফর্মের শর্তানুযায়ী সম্পর্ক বাতিল করতে পারে। বকেয়া হালাল পারিশ্রমিক ন্যায়সঙ্গতভাবে নিষ্পত্তি করা হবে।" },
];
